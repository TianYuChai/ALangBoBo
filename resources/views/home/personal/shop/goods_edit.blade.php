                    ...
                    <div class="col-sm-10">
                        <div class="has-warning">
                            <div class="checkbox">
                                <label>
                                    <input type="text" class="form-control"
                                           autocomplete="off" id="test1" name="presell_time" value="{{ $item->presell_time }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="has-warning">
                            <div class="checkbox">
                                <label>
                                    <input type="radio" name="sales_way" id="sales_way" value="1" {{ $item->sales_way == 1 ? 'checked' : '' }}>
                                    商家代售
                                </label>
                                <label>
                                    <input type="radio" name="sales_way" id="sales_way" value="2" {{ $item->sales_way == 2 ? 'checked' : '' }}>
                                    自售
                                </label>
                            </div>
                        </div>
